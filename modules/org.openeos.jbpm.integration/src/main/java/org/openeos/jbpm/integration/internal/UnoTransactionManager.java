...
public class UnoTransactionManager extends DroolsSpringTransactionManager {

	private UnoProcessPersistenceContext unoProcessPersistenceContext;
	...
	public void commit(boolean transactionOwner) {
		unoProcessPersistenceContext.saveAll();
