...
public class UnoProcessInstanceInfo extends ProcessInstanceInfo {
	...
	public UnoProcessInstanceInfo(Long processInstanceId, String processId, Date startDate, Date lastReadDate,
			Date lastModificationDate, int state, byte[] processInstanceByteArray, Set<String> eventTypes) {
	 ...
	 * </p>
	 * So instead of that, we just add the getters and use
		...
		if (processInstance == null) {
			try {
				...
				MarshallerReaderContext context = new MarshallerReaderContext(bais,
						(InternalRuleBase) ((InternalKnowledgeBase) kruntime.getKnowledgeBase()).getRuleBase(), null, null,
	...
	private void saveProcessInstanceType(MarshallerWriteContext context, ProcessInstance processInstance, String processInstanceType)
			throws IOException {
	 ...
	 * </ul>
	 * </p>
	 * Normally, the variable change is logged after the following method has
	 * completed.
	 */
	@PreUpdate
	public void update() {
	...
	public boolean equals(Object obj) {
		...
		final UnoProcessInstanceInfo other = (UnoProcessInstanceInfo) obj;
		if (this.processInstanceId != other.processInstanceId
				&& (this.processInstanceId == null || !this.processInstanceId.equals(other.processInstanceId))) {
			return false;
		}
		...
		if (this.processInstance != other.processInstance
				&& (this.processInstance == null || !this.processInstance.equals(other.processInstance))) {
			return false;
		}
