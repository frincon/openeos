...
public class IdentificationCapableStringResolver implements EntityToStringResolver {

	@Override
	public String tryResolveString(Object entity) {
		if (entity instanceof IIdentificationCapable) {
			IIdentificationCapable identif = (IIdentificationCapable) entity;
