...
public class UnencapsulateCauseExceptionResolver extends UnencapsulateExceptionResolver {

	public UnencapsulateCauseExceptionResolver(ThrowableToMessageService throwableToMessageService) {
