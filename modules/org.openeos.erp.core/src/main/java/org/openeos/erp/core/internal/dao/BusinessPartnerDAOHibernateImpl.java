...
public class BusinessPartnerDAOHibernateImpl extends GenericDAOHibernateImpl<BusinessPartner, String> implements BusinessPartnerDAO {
	
	public BusinessPartnerDAOHibernateImpl() {
