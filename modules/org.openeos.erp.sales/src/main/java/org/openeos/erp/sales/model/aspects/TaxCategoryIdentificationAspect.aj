...
public aspect TaxCategoryIdentificationAspect {

	String around(TaxCategory taxCategory) : execution(String IIdentificationCapable.getIdentifier()) && this(taxCategory) {
