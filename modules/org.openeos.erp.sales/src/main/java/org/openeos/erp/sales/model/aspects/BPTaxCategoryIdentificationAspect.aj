...
public aspect BPTaxCategoryIdentificationAspect {

	String around(BPTaxCategory taxCategory) : execution(String IIdentificationCapable.getIdentifier()) && this(taxCategory) {
